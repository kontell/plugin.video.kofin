...
**Kodi setting names (continued).** `#30552` still names Kodi's *Sync playback to display*; keep using that locale's Kodi wording, in the same ASCII or locale quotes the string already uses.
