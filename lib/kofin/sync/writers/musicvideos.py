# -*- coding: utf-8 -*-
"""Music-video writer (fork ``objects/musicvideos.py`` port). Adaptations
per plan §3: imports/shims, addon id and path base, ``direct_path`` branches
stripped (plugin mode only), ``self.server`` is the kofin Api."""
...
from kofin.sync.kodidb import MusicVideos as KodiDb
